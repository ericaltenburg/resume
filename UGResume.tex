...
\textbf{Operation Peak} Personal \hfill December 2019\par
\begin{itemize}
	\item Automated the setup of a MacBook by writing a bash script to auto-install applications and copy previous Sublime Text settings to their respective directories
\end{itemize}
