...
\begin{itemize}
	...
	\setlength\tabcolsep{6 pt}
			\begin{tabular}[t]{l l l}
				Data Structures & Systems Programming & Web Programming I \& II\\ %& Modern Algebra\\
...
% C, C++, CSS, HTML, Java, JavaScript, \LaTeX, ARMv8 Assembly, OCaml, Python, R
...
\begin{itemize}
	...
	% \item Challenged with developing different approaches for explaining topics such as sorting, dynamic programming, greedy algorithms, and analyzing code complexity to students one-on-one (OLD)
	% include debugging?
	...
	% \item Led weekly programming labs and held office hours to provide extra help for struggling students (OLD)
	% \item Graded exams and assignments on a weekly basis and communicated with students to resolve any questions about grading (OLD)
...
\begin{itemize}
	...
	% \item Built a classifier decision tree with Python's scikit-learn to analyze raw flight data and produce a prediction for all the maneuvers a drone will perform during its flight which yielded a 95\% success rate
	% \item Evaluated the risk analysis of using different machine learning models such as random forests, boosted trees, neural networks, and decision trees to ensure the accuracy of the model while making sure the learning curve does not derail the project's timeline (OLD)
...
\begin{itemize}
	...
	% \item Utilized worker threads to generate a list of stock tickers from a web scraper that pulls from various subreddits
...
\begin{itemize}
	...
	% \item Created features that students can use to post on a class page and vote on posts they feel deserve more attention
	\item Implemented a web forum for posting on different class pages with a vote based ranking system
	% \item Implemented client-side form validation which would then send an AJAX post request to necessary endpoints
